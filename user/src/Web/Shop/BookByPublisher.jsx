...
function BookByPublisher() {
    const location = useLocation()
    const {publisherId} = location.state || {}
    ...
    useEffect(() => {
        if(publisherId) {
            const fetchdata = async () => {
                try {
                    const response = await axios.get(`http://localhost/BackEnd-Laravel-BookStore/public/api/home/publisher/${publisherId}`)
